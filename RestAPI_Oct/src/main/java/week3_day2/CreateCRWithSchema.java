...
public class CreateCRWithSchema {
	
	@Test
	public void createcrwithheader() {
		File inputPayLoadFile = new File("./data/testdata.json");
		File jsonschemafile = new File("./data/jsonschema.json");
		...
		RequestSpecification inputRequest = RestAssured
				...
				create_response.then().assertThat().body(JsonSchemaValidator.matchesJsonSchema(jsonschemafile));
